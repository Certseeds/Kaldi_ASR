...
srcdir=/data1/${name}/kaldi-trunnk/egs/aishell2/s5/exp/chain/tdnn_1b_all_sp
...
echo "$0: feature type is raw"
  feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/utt2spk scp:$sdata/cmvn.scp scp:$sdata/feats.scp ark:- |"
else
  feats="ark,s,cs:apply-cmvn-online $cmvn_opts $srcdir/global_cmvn.stats scp:$sdata/feats.scp ark:- |"
fi
